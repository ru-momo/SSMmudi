...
<head>
    ...
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/static/web/Product/main.js"></script>
    <link rel="stylesheet" type="text/css"
          href="${pageContext.request.contextPath}/static/web/Product/main.css"/>
...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <c:forEach items="${page.rows}" var="nl">
        <tr>
            <td width="5%">${nl.id}</td>
            <td width="5%">${nl.name}</td>
            <td width="20%">${nl.info}</td>
            <td width="20%">${nl.introduce}</td>
            <td width="4%">${nl.typeId}</td>
            <td width="4%">${nl.alcoholicStrength}%</td>
            <td width="4%">${nl.areaId}</td>
            <td width="4%">${nl.netWeight}ml</td>
            <td width="4%">${nl.saleCount}</td>
            <td width="20%">${nl.bigImg}</td>
            <td width="10%">
        ...
        <div class="modal-content">
            ...
            <form id="frm" method="post" enctype="multipart/form-data">
                ...
                <table class="table table-bordered table-hover definewidth m10">
                    ...
                    <tr>
                        <td class="tableleft">酒精度(单位:%)</td>
                        <td><input type="text" id="alcoholicStrength" name="alcoholicStrength"></td>
                    </tr>
                    <tr>
                        <td class="tableleft">地区编号</td>
                    ...
                    <tr>
                        <td class="tableleft">净含量(单位:ml)</td>
                        <td><input type="text" id="netWeight" name="netWeight"></td>
                    </tr>
                    <tr>
                        <td class="tableleft">销量</td>
                        <td><input type="text" id="saleCount" name="saleCount" value="0"></td>
                    </tr>
                    <tr>
