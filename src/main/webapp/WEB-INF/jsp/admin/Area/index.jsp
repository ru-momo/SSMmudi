...
<head>
    ...
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/static/web/Area/main.js"></script>
    <link rel="stylesheet" type="text/css"
          href="${pageContext.request.contextPath}/static/web/Area/main.css"/>

</head>
<body>
<form class="form-inline definewidth m20" action="index" method="get">
    地区名称： <input type="text" name="name" id="name"
                 class="abc input-default" placeholder="" value="${name}">&nbsp;&nbsp;
    <button type="submit" class="btn btn-primary">查询</button>&nbsp;&nbsp;
    <button type="button" class="btn btn-success" id="addnew" data-toggle="modal" data-target="#myModal">添加地区</button>&nbsp;&nbsp;
...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <c:forEach items="${page.rows}" var="nl">
        <tr>
            ...
            <td width="60%">${nl.name}</td>
            <td width="10%">${nl.parentId}</td>
            <td width="20%">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="frm" method="post">
                ...
                <table class="table table-bordered table-hover definewidth m10">
                    <tr>
                        <td width="15%" class="tableleft">地区名字</td>
                        <td><input type="text" id="tname" name="name"/></td>
                    </tr>
                    <tr>
                        <td width="15%" class="tableleft">地区等级</td>
